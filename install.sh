...
srcdir=/run/readsb
repo="https://github.com/PauloHenriqueOfc/tar1090"
...
if [[ "$1" == "test" ]] || [[ -n "$git_source" ]]; then
    ...
    VERSION_NEW=$(curl --silent --show-error "https://raw.githubusercontent.com/PauloHenriqueOfc/tar1090/master/version")
